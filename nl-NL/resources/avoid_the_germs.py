...
def speler_gebotst():
  ...
  fill(178, 200, 145)
  ellips(mouse_x, speler_y + 20, 10, 10)
...
def teken_speler():
  ...
  botsen = get(mouse_x, speler_y)
  botsen2 = get(mouse_x, speler_y + 30)
  botsen3 = get(mouse_x + 30, speler_y)
  botsen4 = get(mouse_x, speler_y - 30)
...
# Houdt dit om je code uit te voeren
run()
