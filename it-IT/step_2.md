...
Apri [Non scontrarti! progetto iniziale](https://editor.raspberrypi.org/en/projects/dont-collide-starter) progetto {:target="_blank"}. L'editor si aprirà in un'altra scheda del browser.
