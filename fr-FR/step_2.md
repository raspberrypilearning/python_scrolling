...
Ouvre le projet de démarrage [Pas de collision ! ](https://editor.raspberrypi.org/en/projects/dont-collide-starter){:target="_blank"}. Le Code Editor s'ouvrira dans un autre onglet du navigateur.
