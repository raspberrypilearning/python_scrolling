...
Μπορείς να χρησιμοποιήσεις τη μεταβλητή `level` για να σηματοδοτήσεις το 'Τέλος παιχνιδιού' ορίζοντας την στο 0 — μια τιμή που δεν θα φτάσει ποτέ με άλλο τρόπο. Do this in the `else` step of your collision detection code.
